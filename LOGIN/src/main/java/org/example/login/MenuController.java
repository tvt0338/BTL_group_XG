...
public class MenuController{
    ...
    public void onHelpButtonClick(ActionEvent event) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/org/example/Help/Help_screen.fxml"));
    ...
    public void onSettingButtonClick(ActionEvent event) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/org/example/setting/Setting_screen.fxml"));
    ...
    public void onAuthorsButtonClick(ActionEvent event) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/org/example/authors/Author_screen.fxml"));
