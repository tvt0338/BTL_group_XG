...
import menu.screen_2.PlayController;
...
public class MenuController {
    ...
    private void onPlayButtonClick(ActionEvent event) {
        // Dừng nhạc menu và phát nhạc map1
        music_menu.stopMusic();
        music_map1.playMusic();
        ...
        // Load Play.fxml và chuyển scene delay 0.5s
        PauseTransition delay = new PauseTransition(Duration.seconds(0.5));
        delay.setOnFinished(e -> {
            try {
                Parent root = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("screen_2/Play.fxml")));
    ...
    public void onAuthorsButtonClick(ActionEvent event) {
        ...
        // Load AUthors.fxml và chuyển scene delay 0.5s
        PauseTransition delay = new PauseTransition(Duration.seconds(0.5));
        delay.setOnFinished(e -> {
            try {
